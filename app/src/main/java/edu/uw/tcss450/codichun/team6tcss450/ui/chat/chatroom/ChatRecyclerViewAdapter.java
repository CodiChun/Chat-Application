...
import edu.uw.tcss450.codichun.team6tcss450.databinding.FragmentChatMessageBinding;
    ...
    class MessageViewHolder extends RecyclerView.ViewHolder {
        ...
        void setMessage(final ChatMessage message) {
            ...
            if (mEmail.equals(message.getSender())) {
                ...
                card.setCardBackgroundColor(
                        ColorUtils.setAlphaComponent(
                                res.getColor(com.google.android.material.R.color.design_default_color_secondary, null),
                                16));
